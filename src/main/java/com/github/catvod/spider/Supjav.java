...
public class Supjav extends Spider {
    ...
    private String parseTV(String redirect) throws MalformedURLException {
        ...
        return Result.get().url(Util.getVar(data, "urlPlay")).header(getTVVideoHeaders(URLUtil.getHost(Urls.create(redirect, Urls.HTTP_PROTOCOLS, HostValidator.DENY_COMMON_INFRASTRUCTURE_TARGETS)).toString())).string();
    }
